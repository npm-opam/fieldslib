(* OASIS_START *)
(* DO NOT EDIT (digest: 0f6387d55b9801682503df7a9944ec71) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2009-2016 Jane Street Group LLC <opensource@janestreet.com>"
            ];
          maintainers =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "o2r\006\193(V?P^d\191\247\"\235\237";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
